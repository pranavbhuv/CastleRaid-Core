                ...
                foreach($data as $value){
                    ...
                    foreach(self::$quests as $id => $index){
                        ...
                        foreach($index['Needed-Items'] as $items)
                            if($player->getInventory()->contains($items) == false) $player->sendMessage(Quests::QUEST_PREFIX . 'You do not have all the items needed to complete this quest!');
