...
class MPShopCommand extends BaseCommand{
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args){
        ...
        $form = $api->createSimpleForm(function (Player $person, ?string $data){
        ...
        $form->addButton(TextFormat::DARK_AQUA . "Tier 1 | $20k", -1, "", "tier1");
        $form->addButton(TextFormat::DARK_GREEN . "Tier 2 | $40k", -1, "", "tier2");
        $form->addButton(TextFormat::DARK_RED . "Tier 3 | $80k", -1, "", "teir3");
