		...
		if($item->getId() === 373){
			...
			switch($damage){
				case 100:
					...
					$inventory->removeItem(Item::get(Item::POTION, 100, 1));
					$inventory->addItem(Item::get(Item::GLASS_BOTTLE, 0, 1));
				...
				case 101:
					...
					$inventory->removeItem(Item::get(Item::POTION, 101, 1));
				...
				case 102:
					...
					$player->addEffect(Effect::getEffect(Effect::NIGHT_VISION)->setDuration(360 * 20)->setAmplifier(1));
					$inventory->removeItem(Item::get(Item::POTION, 102, 1));
					$inventory->addItem(Item::get(Item::GLASS_BOTTLE, 0, 1));
				...
				case 103:
					...
					$inventory->removeItem(Item::get(Item::POTION, 103, 1));
					$inventory->addItem(Item::get(Item::GLASS_BOTTLE, 0, 1));
				...
				case 104:
					...
					$player->addEffect(Effect::getEffect(Effect::NIGHT_VISION)->setDuration(360 * 20)->setAmplifier(1));
					$player->addEffect(Effect::getEffect(Effect::DAMAGE_RESISTANCE)->setDuration(360 * 20)->setAmplifier(1));
					$inventory->removeItem(Item::get(Item::POTION, 104, 1));
					$inventory->addItem(Item::get(Item::GLASS_BOTTLE, 0, 1));
